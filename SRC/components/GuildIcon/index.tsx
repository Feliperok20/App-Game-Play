...
export function GuildIcon({guildId, iconId}:Props){
    ...
    return(
        <View style={styles.container}>
            ...
            source={{uri}}
            style={styles.image}
            resizeMode="cover"// se a imagem nao estiver em uma proporcao legal ela se auto ajusta 
            />
             :     
           <DiscordSvg 
           width={40}
